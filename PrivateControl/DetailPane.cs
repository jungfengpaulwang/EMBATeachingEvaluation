...
namespace TeachingEvaluation.PrivateControl
{
    partial class DetailPane : UserControl
    {
        ...
        public DetailPane()
        {
            ...
            DetailItemContainers.HorizontalScroll.Enabled = false;
        ...
        public void DeleteDetailItem(PrivateControl.DetailContent content)
        {
            ...
            List<FlowLayoutPanel> links = new List<FlowLayoutPanel>();
            foreach (FlowLayoutPanel link in ContentLinks.Controls)
            {
                string Group = (link.Controls[1] as LinkLabel).Tag + "";
            ...
            int count = 0;
            foreach (FlowLayoutPanel link in links)
            {
        ...
        public void Clear()
        {
            ...
            //}
            //this.DetailItemContainers.SuspendPaint = true;
            _Containers.Clear();
            ...
            //this.DetailItemContainers.SuspendPaint = false;
            DetailItemContainers.ResumeLayout(false);
            ContentLinks.ResumeLayout(false);
        }
        ...
        public void AddDetailItem(PrivateControl.DetailContent content)
        {
            ...
            if (content.DisplayOrder == null)
            {
                ...
                foreach(DetailContent x in contents)
                {
                    if (x.HierarchyTitle != content.HierarchyTitle)
                        continue;
        ...
        private void lnkAddQuestion_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            List<UDT.Hierarchy> Hierarchies = (new FISCA.UDT.AccessHelper()).Select<UDT.Hierarchy>();
            PrivateControl.DetailContent DetailContent = QuestionTemplate.TemplatePool.GetTemplate<QuestionTemplate.SingleChoice>();
            DetailContent.PrimaryKey = this.PrimaryKey;
            DetailContent.Record = new UDT.Question();
            DetailContent.SurveyID = int.Parse(this.PrimaryKey);
            DetailContent.Record.SurveyID = DetailContent.SurveyID;
            DetailContent.HierarchyTitle = string.Empty;
            DetailContent.HierarchyTitleSource = (new List<string>() { "" }).Union(Hierarchies.Select(y => y.Title)).ToList();
            ...
            this.label_Click(DetailContent, null);
        }
        ...
        private void lnkAddEssay_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            List<UDT.Hierarchy> Hierarchies = (new FISCA.UDT.AccessHelper()).Select<UDT.Hierarchy>();
            PrivateControl.DetailContent DetailContent = QuestionTemplate.TemplatePool.GetTemplate<QuestionTemplate.Essay>();
            DetailContent.PrimaryKey = this.PrimaryKey;
            DetailContent.Record = new UDT.Question();
            DetailContent.SurveyID = int.Parse(this.PrimaryKey);
            DetailContent.Record.SurveyID = DetailContent.SurveyID;
        ...
        private void lnkAddMultiChoice_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            List<UDT.Hierarchy> Hierarchies = (new FISCA.UDT.AccessHelper()).Select<UDT.Hierarchy>();
            PrivateControl.DetailContent DetailContent = QuestionTemplate.TemplatePool.GetTemplate<QuestionTemplate.MultiChoice>();
            DetailContent.PrimaryKey = this.PrimaryKey;
            DetailContent.Record = new UDT.Question();
            DetailContent.SurveyID = int.Parse(this.PrimaryKey);
            DetailContent.Record.SurveyID = DetailContent.SurveyID;
