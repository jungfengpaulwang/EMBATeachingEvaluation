...
{
    public partial class ExportEvaluation_Course : BaseForm
    {
        ...
        public ExportEvaluation_Course()
        {
            InitializeComponent();
            this.Text = "列印開課評鑑統計";
            this.TitleText = "列印開課評鑑統計";
            Query = new QueryHelper();
            Access = new AccessHelper();

            this.Load += new EventHandler(ExportEvaluation_Course_Load);
        }

        private void ExportEvaluation_Course_Load(object sender, EventArgs e)
        {
        ...
        //            if (!dicStyles.ContainsKey(CourseID))
        //                dicStyles.Add(CourseID, new Dictionary<CellObject, CellStyle>());

        //            Dictionary<ReportHelper.CellObject, ReportHelper.CellStyle> dicCellStyles = dicStyles[CourseID];
        ...
        //            if (!file_TeacherStatistics.ContainsKey(CourseID))
        //                file_TeacherStatistics.Add(CourseID, new Dictionary<string, List<DataSet>>());

        //            if (!file_TeacherStatistics[CourseID].ContainsKey(key))
        //                file_TeacherStatistics[CourseID].Add(key, new List<DataSet>());

        //            file_TeacherStatistics[CourseID][key].Add(dataSet_PageHeader);
        //            file_TeacherStatistics[CourseID][key].Add(dataSet_DataSection);
        //        }
        ...
        //            string file_name = o.SchoolYear + "-" + o.Semester + "-" + o.CourseName + "-開課教學評鑑統計表";
